...
<head>
    ...
    <title>Admin - Edit Transport</title>
            ...
            <div class="col-lg-6">
                <div class="banner-text">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Transport</li>
                    </ol>
                </div>
            </div>
            <div class="col-lg-6">
...
<section class="gap transports-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form action="/editTransport" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="transportName" name="transportName" value="${transport.transportName}" required>
                    </div>
                    <div class="form-group">
                        <label for="priceTransPort">Price:</label>
                        <input type="number" class="form-control" id="priceTransPort" name="priceTransPort" value="${transport.priceTransPort}" required>
                    </div>
                    <div class="form-group">
                        <label for="descriptionTransport">Description:</label>
                        <textarea class="form-control" id="descriptionTransport" name="descriptionTransport" rows="3" required>${transport.descriptionTransport}</textarea>
                    </div>
