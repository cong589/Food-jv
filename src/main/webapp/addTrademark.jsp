...
<section class="hero-section" style="background-color: #fff8e5; background-image:url(assets/img/background.png)">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="hero-text">
                    <h1>Add New Trademark</h1>
                    <h3>Fill in the details below to add a new trademark.</h3>
                </div>
            </div>
        </div>
    </div>
...
<section class="gap">
    <div class="container">
        <form action="addTrademark" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="trademarkName" name="trademarkName" class="form-control" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="descriptionTrademark" name="descriptionTrademark" class="form-control" required></textarea>
                    </div>
