            ...
            <div class="col-lg-6">
                <div class="banner-text">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Đăng ký Shipper</li>
                    </ol>
                </div>
            </div>
            <div class="col-lg-6">
...
<section class="gap registration-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form action="/shipper" method="post">
                    <input type="text" class="form-control" id="userID" name="userID" required hidden value="${sessionScope.user.userID}">
                    <div class="form-group">
                        <label for="description">Giới thiệu cơ bản về bản thân</label>
                        <textarea class="form-control" id="description" name="description" rows="4" required></textarea>
                    </div>
                    <button type="submit" class="btn btn-primary" onclick="alert('Bạn có chắc chắn muốn trở thành người giao hàng của chúng tôi?')">Đăng ký</button>
                </form>
            </div>
        </div>
    </div>
