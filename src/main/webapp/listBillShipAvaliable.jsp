        ...
        <table class="table table-bordered">
            ...
            <c:forEach items="${listBills}" var="bill">
                <tr>
                    ...
                    <td>
                        <form action="/acceptShipping" method="post">
                            <input type="hidden" name="billID" value="${bill.billId}">
                            <button type="submit" class="btn btn-success" onclick="alert('Bạn có chắc chắn muốn nhận giao đơn hàng này?')">Nhận đơn</button>
                        </form>
                    </td>
                </tr>
            </c:forEach>
