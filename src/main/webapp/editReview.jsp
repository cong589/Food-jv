    ...
    <div class="container">
        <form action="/editReview" method="post">
            ...
            <div class="form-group">
                <label for="starQuantity">Số sao</label>
                <input type="number" class="form-control" id="starQuantity" name="starQuantity" min="1" max="5" value="${review.starQuantity}" required>
            </div>
            <div class="form-group">
                <label for="content">Nội dung</label>
                <textarea class="form-control" id="content" name="content" rows="3" required>${review.content}</textarea>
            </div>
            <button type="submit" class="btn btn-primary">Cập nhật review</button>
        </form>
    </div>
</section>
