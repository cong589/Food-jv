    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="hero-text">
                    <h1>Add New Size</h1>
                    <h3>Fill in the details below to add a new size.</h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="sizeName" name="sizeName" class="form-control" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="describeSize">Size Describe</label>
                        <textarea id="describeSize" name="describeSize" class="form-control" required></textarea>
                    </div>
