...
<section class="gap">
    <div class="container">
        <a href="/addUser" class="btn btn-primary">Thêm người dùng</a>
        <table class="table table-bordered">
            ...
            <c:forEach var="user" items="${listUser}">
                <tr>
                    ...
                    <td>${user.address}</td>
                    <td>${user.typeAccountName}</td>
                    <td>
                        <c:if test="${user.ban == false}">
                            <a href="/blockUser?userID=${user.userID}" class="btn btn-danger">Cấm</a>
                        </c:if>
                        <c:if test="${user.ban == true}">
                            <a href="/unblockUser?userID=${user.userID}" class="btn btn-success">Bỏ cấm</a>
                        </c:if>
                        <a href="/editUserInfo?userID=${user.userID}" class="btn btn-warning">Sửa</a>
                        <a href="deleteUser?userID=${user.userID}" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa người dùng này?');">Xóa</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
